...
ch2, pval2,dof2,expected2 = chi2_contingency(contingency2)
print(pval2)
...
ax2 = plt.subplot()
ax2.bar(obs_by_park.park_name, obs_by_park.observations)
ax2.set_xticks
...
Bryce_analysis_per_week = 890/250
Yellowstone_analysis_per_week = 890/507
print(Bryce_analysis_per_week)
print(Yellowstone_analysis_per_week)
